...
0. Prerequisites: install the v0.2.0 archive from the README in an app using Vue 3.3 or later.
...
- Snapshot includes countdown, active duration in seconds, Blob, preview URL, actual MIME type and error text.
